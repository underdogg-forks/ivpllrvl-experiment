...
Route::middleware('web')->group(function () {
    ...
    Route::get('invoices/status/all', [InvoicesController::class, 'status'])->defaults('status', 'all')->name('invoices.status.all');
    Route::get('invoices/status/approved', [InvoicesController::class, 'status'])->defaults('status', 'approved')->name('invoices.status.approved');
    Route::get('invoices/status/canceled', [InvoicesController::class, 'status'])->defaults('status', 'canceled')->name('invoices.status.canceled');
    Route::get('invoices/status/draft', [InvoicesController::class, 'status'])->defaults('status', 'draft')->name('invoices.status.draft');
    Route::get('invoices/status/rejected', [InvoicesController::class, 'status'])->defaults('status', 'rejected')->name('invoices.status.rejected');
    Route::get('invoices/status/sent', [InvoicesController::class, 'status'])->defaults('status', 'sent')->name('invoices.status.sent');
    Route::get('invoices/status/viewed', [InvoicesController::class, 'status'])->defaults('status', 'viewed')->name('invoices.status.viewed');
    Route::get('invoices/status/paid', [InvoicesController::class, 'status'])->defaults('status', 'paid')->name('invoices.status.paid');
    Route::get('invoices/status/overdue', [InvoicesController::class, 'status'])->defaults('status', 'overdue')->name('invoices.status.overdue');
    ...
    Route::get('invoices/generate_pdf', [InvoicesController::class, 'generatePdf'])->name('invoices.generate_pdf');
