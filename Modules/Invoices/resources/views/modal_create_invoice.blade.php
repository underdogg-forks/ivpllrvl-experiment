...
<div id="create-invoice" class="modal modal-lg"
    ...
    <form class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="fi-section-title">{{ trans('create_invoice') }}</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="fi-field-wrp has-feedback">
                ...
                <div class="input-group">
                    ...
                    <select name="client_id" id="create_invoice_client_id" class="client-id-select fi-input"
        ...
        <div class="modal-footer">
            <div class="btn-group">
                <button class="fi-btn-success ajax-loader" id="invoice_create_confirm" type="button">
