...
<div id="modal_copy_invoice" class="modal modal-lg" role="dialog" aria-labelledby="modal_copy_invoice"
    ...
    <form class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="fi-section-title">{{ trans('copy_invoice') }}</h4>
        </div>
        <div class="modal-body">

            <input type="hidden" name="user_id" id="user_id" value="{{ $invoice->user_id }}">
            <input type="hidden" name="payment_method" id="payment_method" class="fi-input"
            ...
            <div class="fi-field-wrp has-feedback">
                ...
                <div class="input-group">
                    ...
                    <select name="client_id" id="client_id" class="client-id-select fi-input" autofocus="autofocus" required="required">
                        @if (!empty($client))
            ...
            <div class="fi-field-wrp has-feedback">
                ...
                <div class="input-group">
                    <input name="invoice_date_created_modal" id="invoice_date_created_modal" class="fi-input datepicker"
        ...
        <div class="modal-footer">
            <div class="btn-group">
                <button class="fi-btn-success" id="copy_invoice_confirm" type="button">
