...
/**
 * InvoicesController Deletion Validation Feature Tests.
 *
 * Tests business rules for invoice deletion:
 * - Draft invoices (status = 1) can be deleted
 * - Sent invoices (status != 1) cannot be deleted unless config allows
 * - Tasks are unmarked when invoice is deleted
 */
