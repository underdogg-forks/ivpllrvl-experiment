...
<form method="post">
    ...
    <div id="content">
        ...
        <div class="fi-field-wrp mb-4">
            ...
            <input type="text" name="project_name" id="project_name" class="fi-input w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                   value="{{ old('project_name', $project->project_name ?? '') }}" required>
        </div>

        <div class="fi-field-wrp has-feedback mb-4">
            ...
            <div class="input-group flex">
                ...
                <select name="client_id" id="client_id" class="client-id-select fi-input flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-r-md focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" autofocus="autofocus">
@php
