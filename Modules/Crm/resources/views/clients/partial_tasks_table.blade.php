...
@endif
                ...
                <td class="px-4 py-2">
                    <div x-data="{ taskMenuOpen: false }" class="relative inline-block text-left">
                        <button @click="taskMenuOpen = !open" type="button"
                        ...
                        <ul x-show="taskMenuOpen" @click.away="taskMenuOpen = false" x-cloak
