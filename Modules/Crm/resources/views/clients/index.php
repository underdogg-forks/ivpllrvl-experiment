...
if ($open_quotes) {
    ...
    ?>
            <div class="alert text-success no-margin">{{ trans('no_quotes_requiring_approval') }}</div>
<?php
}
    ?>
...
if ($overdue_invoices) {
    ...
    ?>
            <div class="alert text-success no-margin">{{ trans('no_overdue_invoices') }}</div>
<?php
}
    ?>
...
if ($open_invoices) {
    ...
    ?>
            <div class="alert text-success no-margin">{{ trans('no_open_invoices') }}</div>
<?php
}
    ?>
