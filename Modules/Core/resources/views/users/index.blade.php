...
<div id="headerbar" class="flex flex-wrap justify-between items-center mb-4">
    ...
    <div class="headerbar-item">
        <a class="btn btn-sm btn-primary inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 dark:bg-blue-500 border border-transparent rounded-md text-sm font-medium text-white hover:bg-blue-700 dark:hover:bg-blue-600" href="{{ route('users.create') }}">
