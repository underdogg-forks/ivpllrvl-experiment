...
@if($errors)
                <input type="submit" class="fi-btn-primary inline-flex items-center gap-2 px-4 py-2 bg-blue-600 dark:bg-blue-500 border border-transparent rounded-md text-sm font-medium text-white hover:bg-blue-700 dark:hover:bg-blue-600" name="btn_try_again"
