        ...
        <form method="post" action="{{ route($this->uri->uri_string()) }}">
            ...
            @if( ! $database['success'])
                ...
                <div class="fi-field-wrp">
                    ...
                    <input type="text" name="db_hostname" id="db_hostname" class="fi-input"
                ...
                <div class="fi-field-wrp">
                    ...
                    <input type="text" name="db_port" id="db_port" class="fi-input"
                ...
                <div class="fi-field-wrp">
                    ...
                    <input type="text" name="db_username" id="db_username" class="fi-input"
                ...
                <div class="fi-field-wrp">
                    ...
                    <input type="password" name="db_password" id="db_password" class="fi-input"
                ...
                <div class="fi-field-wrp">
                    ...
                    <input type="text" name="db_database" id="db_database" class="fi-input"
                           value="{{ $this->input->post('db_database') }}">
                    <span class="help-block">{{ trans('setup_db_database_info') }}</span>
                </div>
            @endif
            @if($errors)
                <input type="submit" class="fi-btn-primary" name="btn_try_again"
