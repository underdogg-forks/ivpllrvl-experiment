...
@endphp
                                <div class="input-group flex">
                                    ...
                                    <input type="text" name="item_discount_amount" id="item_discount_amount_{{ $item_id }}" class="form-control flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
