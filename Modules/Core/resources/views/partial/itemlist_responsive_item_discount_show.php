...
<hr class="no-margin">
                                <div class="row mb-1">
                                    <div class="col-xs-9 col-sm-8">{{ trans('item_discount') }}:</div>
...
if ( ! $legacy_calculation && $item_global_discount) {
    ?>
                                <div class="row mb-1">
                                    <div class="col-xs-9 col-sm-8">{{ trans('global_discount') }}:</div>
                                    <div class="col-xs-3 col-sm-4"><?php echo format_currency($item_global_discount); ?></div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-xs-9 col-sm-8">{{ trans('discount') }} ({{ trans('subtotal') }}):</div>
