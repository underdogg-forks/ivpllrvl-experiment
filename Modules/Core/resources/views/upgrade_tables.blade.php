<div class="container mx-auto px-4 py-8">
    <div class="install-panel max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-8">
        ...
        <form method="post" class="form-horizontal" action="{{ route('setup.upgrade_tables') }}">
...
@if($errors)
                <input type="submit" class="btn btn-danger inline-flex items-center gap-2 px-4 py-2 bg-red-600 dark:bg-red-500 border border-transparent rounded-md text-sm font-medium text-white hover:bg-red-700 dark:hover:bg-red-600" name="btn_try_again"
