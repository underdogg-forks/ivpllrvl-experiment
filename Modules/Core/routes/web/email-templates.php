...
Route::middleware('web')->group(function () {
    ...
    Route::match(['get', 'post'], 'email-templates/form/{email_template_id?}', [EmailTemplatesController::class, 'form'])->name('email-templates.form');
    Route::post('email-templates/delete/{email_template_id}', [EmailTemplatesController::class, 'delete'])->name('email-templates.delete');
