...
class CustomValuesHelper
{
     ...
     */
    public static function format_date($txt)
    {
        if ($txt == null) {
            return '';
        }
     ...
     * @return string
     */
    public static function format_text($txt)
    {
        if ($txt == null) {
            return '';
        }
     ...
     * @return string
     */
    public static function format_singlechoice($txt)
    {
        if ($txt == null) {
            return '';
        }
     ...
     * @return string
     */
    public static function format_boolean($txt)
    {
        if ($txt == null) {
            return '';
        }
     ...
     * @return string|null
     */
    public static function format_avs($txt)
    {
     ...
     * @return string
     */
    public static function format_fallback($txt)
    {
     ...
     */
    public static function print_field($module, $custom_field, array $cv, $class_top = '', $class_bottom = 'controls', $class_label = '', $class_group = 'form-group'): void
    {
