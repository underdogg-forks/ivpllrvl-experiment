                                ...
                                <select name="item_product_unit_id" id="item_product_unit_id_<?php echo $item->item_id; ?>" class="form-control">
                                    ...
                                    <?php foreach ($units as $unit) { ?>
                                        <option value="<?php echo $unit->unit_id; ?>"
                                            ...
                                            <?php echo htmlsc($unit->unit_name) . 'partial_itemlist_responsive.php/' . htmlsc($unit->unit_name_plrl); ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
            ...
            foreach ($quote_tax_rates as $quote_tax_rate) {
                ?>
                            ...
                            <span class="text-muted">
                                <?php echo htmlsc($quote_tax_rate->quote_tax_rate_name) . ' partial_itemlist_responsive.php' . format_amount($quote_tax_rate->quote_tax_rate_percent) ?>
                            </span>
