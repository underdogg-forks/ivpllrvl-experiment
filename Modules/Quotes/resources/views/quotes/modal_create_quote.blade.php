...
<div id="create-quote" class="modal modal-lg" role="dialog" aria-labelledby="modal_create_quote" aria-hidden="true">
    <form class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="fi-section-title">{{ trans('create_quote') }}</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="fi-field-wrp has-feedback">
                ...
                <div class="input-group">
                    ...
                    <select name="client_id" id="create_quote_client_id" class="client-id-select fi-input"
            ...
            <div class="fi-field-wrp">
                ...
                <input type="text" name="quote_password" id="quote_password" class="fi-input"
            ...
            <div class="fi-field-wrp">
                ...
                <select name="invoice_group_id" id="invoice_group_id"
                    class="fi-input simple-select" data-minimum-results-for-search="Infinity" required>
        ...
        <div class="modal-footer">
            <div class="btn-group">
                <button class="fi-btn-success ajax-loader" id="quote_create_confirm" type="button">
